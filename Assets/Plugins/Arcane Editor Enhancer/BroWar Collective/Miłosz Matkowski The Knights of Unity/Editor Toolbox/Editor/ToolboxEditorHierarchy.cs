...
namespace Toolbox.Editor
{
    ...
    public static class ToolboxEditorHierarchy
    {
        ...
        private static class Style
        {
            ...
            //internal static readonly Color lineColor = EditorGUIUtility.isProSkin ? new Color(0.65f, 0.15f, 0.15f) : new Color(0.69f, 0.69f, 0.69f); //Red
            internal static readonly Color lineColor = EditorGUIUtility.isProSkin ? new Color(0f, 0f, 0f) : new Color(0.69f, 0.69f, 0.69f); //Black
#else
...
#endif
#if UNITY_2019_3_OR_NEWER
            internal static readonly Color labelColor = EditorGUIUtility.isProSkin ? new Color(0.1f, 0.1f, 0.1f) : new Color(0.909f, 0.909f, 0.909f);
#else
